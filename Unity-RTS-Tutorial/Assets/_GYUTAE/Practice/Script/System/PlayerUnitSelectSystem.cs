...
public class PlayerUnitSelectSystem : JobComponentSystem
{
    ...
    {
        // Cache the EndSimulatorBarrier in a field, so we don't have to create it every frame
    ...
    struct PlayerUnitSelectJob : IJobForEachWithEntity<PlayerInput, AABB>
    {
        ...
        public void Execute(Entity entity, int index, [ReadOnly] ref PlayerInput input, ref AABB aabb)
        {
